...
async def upload_to_quest(sess, file_path):
    ...
    while True:
        try:
            r = await sess.get("http://192.168.0.75:50000/main/upload")
            break
    ...
    driver = webdriver.Chrome(executable_path='C:\Program Files (x86)\chrome_driver\\chromedriver.exe', options=options)

    driver.get("http://192.168.0.75:50000/main/upload")
